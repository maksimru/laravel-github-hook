...
use HighSolutions\GitHubHook\Events\GitData;
...
class GitHubHookService {
    ...
    protected function handle()
    {
        ...
        if (is_array($this->config['branch'])) {
            if (isset($this->config['branch'][$this->getRepository()]))
                $allowed_branch = $this->config['branch'][$this->getRepository()];
            else
                $allowed_branch = $this->config['branch']['default'];
        } else
